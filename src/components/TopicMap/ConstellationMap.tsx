...
const topics: Topic[] = [
  ...
  { id: 'electric-charge', label: 'Electric Charge', x: 580, y: 260, subject: 'electricity', route: '/lessons', description: 'Coulombs law' },
  { id: 'circuits', label: 'Circuits', x: 700, y: 340, subject: 'electricity', route: '/lessons', description: 'Kirchhoffs laws' },
...
export default function ConstellationMap() {
  ...
  const hoveredTopic = hovered ? getTopicById(hovered) : null

  return (
    <div className="relative w-full p-4">
      <p className="text-gray-400 text-sm mb-4">
        Hover a topic to preview it. Click to open the lesson. Follow the lines to see what to study first.
      </p>
      <div className="relative w-full rounded-2xl border border-gray-700 bg-gray-900/50 overflow-hidden">
        <svg viewBox="0 0 900 550" width="100%" style={{ minHeight: '500px' }}>
        ...
        {hoveredTopic && (
          ...
          >
            <p className="text-white font-semibold">{hoveredTopic.label}</p>
            <p className="text-gray-400 text-xs mt-1">{hoveredTopic.description}</p>
